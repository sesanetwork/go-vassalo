...
func TestHashgraphClassicRoots(t *testing.T) {
...
func TestHashgraphRandomRoots(t *testing.T) {
	// generated by codegen4HashgraphRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01    
 ║         ║        
 ╠════════ B1.01    
...
/*
// codegen4HashgraphRandomRoot is for test data generation.
func codegen4HashgraphRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakeHashgraph(nodes)
	// process events
	config := inter.Events{}
