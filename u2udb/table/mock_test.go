...
// Source: github.com/Fantom-foundation/lachesis-base/sesadb (interfaces: DBProducer,DropableStore)
...
func (m *MockDBProducer) OpenDB(arg0 string) (sesadb.Store, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "OpenDB", arg0)
	ret0, _ := ret[0].(sesadb.Store)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDropableStore) GetSnapshot() (sesadb.Snapshot, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSnapshot")
	ret0, _ := ret[0].(sesadb.Snapshot)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDropableStore) NewBatch() sesadb.Batch {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewBatch")
	ret0, _ := ret[0].(sesadb.Batch)
	return ret0
}
...
func (m *MockDropableStore) NewIterator(arg0, arg1 []byte) sesadb.Iterator {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewIterator", arg0, arg1)
	ret0, _ := ret[0].(sesadb.Iterator)
	return ret0
}
